...
namespace Zadanie1Tests
{
    public class WypelnianieStalymi : IDataFiller
    {
        public void fill(DataContext context)
        {
            ...
            context.zdarzenia.Add(new Wypozyczenie(0, context.wykazy[0], context.opisyStanu[0], DateTime.Now));
            context.zdarzenia.Add(new Wypozyczenie(1, context.wykazy[2], context.opisyStanu[1], DateTime.Now));           
        }
    }
}
